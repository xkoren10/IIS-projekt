    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category_of_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='index.categories')),
            ],
        ),
        migrations.CreateModel(
            name='Crop',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(max_length=80)),
                ('crop', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='index.crop')),
                ('farmer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='index.user')),
            ],
        ),
        migrations.AddField(
            model_name='crop',
